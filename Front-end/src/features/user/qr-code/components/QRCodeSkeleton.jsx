export default function QRCodeSkeleton() {
  return (
    <section className="bg-[#130F40] px-5 py-7 h-[calc(100vh-60px)] overflow-y-auto">
      ...
      <p className="h-3 w-[14%] bg-[#93A3B6] rounded-md mt-1"></p>
      <div className="mt-5 flex items-start gap-6">
        <div className="bg-[#1E1633] border border-[rgba(255,236,120,0.5)] rounded-md p-6 w-[70%]">
          ...
          <div className="mt-12 border border-[#FFEC78] bg-[#FEF8FD] w-2/5 h-[412px] mx-auto rounded-xl flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="h-5 w-[14%] bg-[#93A3B6] rounded-md"></p>
              <p className="h-3 w-[18%] bg-[#93A3B6] rounded-md -mt-1"></p>
            </div>
          </div>
        ...
        <div className="w-[30%]">
          <div className="bg-[#1E1633] border border-[rgba(255,236,120,0.5)] rounded-md h-20"></div>
          <div className="bg-[#1E1633] border border-[rgba(255,236,120,0.5)] rounded-md h-14"></div>
        </div>
      </div>
    </section>
  );
