          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            <div className="border border-[rgba(255,236,120,0.5)] bg-[#1E1633] p-5 sm:p-6 rounded-md w-full sm:w-2/3 order-2 sm:order-1">
              ...
              <form className="mt-2.5 sm:mt-3.5 w-full sm:w-1/2" noValidate>
                <div className="mb-1.5 sm:mb-2.5">
                  <p className="h-3 w-[35%] bg-[#93A3B6] rounded-md"></p>
                  <p className="h-3 w-[30%] bg-[#130F40] rounded-md mt-1.5 sm:mt-2.5"></p>
                </div>
                <div className="mb-1.5 sm:mb-2.5">
                  <p className="h-3 w-[35%] bg-[#93A3B6] rounded-md"></p>
                  <p className="h-3 w-[30%] bg-[#130F40] rounded-md mt-1.5 sm:mt-2.5"></p>
            ...
            <div className="w-full sm:w-1/3 flex flex-col gap-4 sm:gap-6 order-1 sm:order-2">
              <div className="border border-[rgba(255,236,120,0.5)] bg-[#1E1633] p-5 sm:p-6 rounded-md">
                ...
                <p className="h-3 w-[30%] bg-[#93A3B6] rounded-md mx-auto mt-4 mb-2"></p>
                <p className="h-3 w-[35%] bg-[#130F40] rounded-md mx-auto"></p>
              ...
              <div className="border border-[rgba(255,236,120,0.5)] bg-[#1E1633] p-5 sm:p-6 rounded-md">
                ...
                <div className="mt-2.5 sm:mt-3.5 flex flex-col gap-y-2.5 sm:gap-y-3.5">
                  <div className="pb-3 border-b border-b-[rgba(255,236,120,0.5)] flex flex-col gap-2.5">
                    <p className="h-3 w-[30%] bg-[#130F40] rounded-md"></p>
                    <p className="h-3.5 w-[35%] bg-[#93A3B6] rounded-md"></p>
                  </div>
                  <div className="pb-3 border-b border-b-[rgba(255,236,120,0.5)] flex flex-col gap-2.5">
                    <p className="h-3 w-[30%] bg-[#130F40] rounded-md"></p>
                    <p className="h-3.5 w-[35%] bg-[#93A3B6] rounded-md"></p>
