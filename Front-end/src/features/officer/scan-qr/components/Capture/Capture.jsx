...
export default function Capture({ isScanning, onScanSuccess }) {
  ...
  return (
    <div className="mt-3.5 bg-[#130F40] h-115 sm:h-130 flex justify-center items-center rounded-md">
      <div className="text-center border-2 border-[rgba(255,236,120,0.5)] rounded-xl py-10 sm:py-13 w-[50%] sm:w-[45%]">
        {isScanning ? (
